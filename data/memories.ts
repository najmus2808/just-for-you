...
export const STARTER_MEMORIES: Memory[] = [
  {
    ...
    caption:
      'সেই দিনটার কথা এখনো মনে পড়ে। খুব বেশি কথা হয়নি, তবু কেমন একটা নিশ্চিন্ত অনুভূতি হয়েছিল।',
  },
  {
    id: 'memory-002',
    ...
    location: 'কক্সবাজার',
    caption:
      'সমুদ্রের পাড়ে হাঁটতে হাঁটতে তুমি বলেছিলে, এই মুহূর্তটা যেন থেমে থাকে। আমারও ঠিক তাই মনে হয়েছিল।',
  },
  {
    id: 'memory-003',
