...
export const STARTER_STORY_EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    date: '2023-10-20',
    description:
      'একটা দিনের দেখা থেকে সরাসরি বিয়ে — ভয়ও ছিল, তবে তার চেয়ে বেশি ছিল একটা অন্যরকম বিশ্বাস।',
    isMilestone: true,
  },
  {
    ...
    date: '2023-11-15',
    description:
      'বিয়ের পরেই আসলে আমাদের গল্পটা শুরু হয়েছিল। একটু একটু করে তোমাকে চেনা, আর প্রতিদিন নতুন করে ভালো লাগা।',
  },
  {
    id: 'story-first-trip',
    ...
    date: '2024-01-15',
    description:
      'কক্সবাজারের সমুদ্রের সামনে দাঁড়িয়ে বুঝেছিলাম, ঘুরতে যাওয়া মানেই শুধু জায়গা না, তোমার পাশে থাকাটাই আসল।',
  },
];
